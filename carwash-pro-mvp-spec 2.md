...
3. Veículos
4. Serviços (catálogo real da Orleans Auto Spa — 4 planos de carro + moto + quadriciclo + jet ski, com tela admin de cadastro/edição própria, sem depender de SQL manual — ver `carwash-pro-design-system.md` seção 9)
